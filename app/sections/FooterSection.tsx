...
export default function FooterSection() {
    ...
    return (
        <footer className="bg-orange-400 text-white">
            <section className="py-12 sm:px-24 px-8 flex flex-wrap gap-6 justify-between">
                <div>
                    <Image
            ...
            <p className="mt-8 text-center flex items-center justify-between border-t sm:px-24 px-8 py-8 grided-white">
                <span>
                    Designed by: <Link href={"https//fabiconcept.online"} className="font-semibold hover:text-blue-700">Fabiconcept</Link>
                </span>
                <span>
                    &copy; {todayYr} <span className="font-semibold">Goldwater</span> all rights reserved
                </span>
            </p>
